# Contributing to Contributor Report

Thank you for your interest in contributing to Contributor Report! This document provides guidelines and instructions
for contributing.

## Code of Conduct

By participating in this project, you agree to abide by our Code of Conduct. Please be respectful and constructive in
all interactions.
...
1. Add types to `src/types/metrics.ts`
2. Export from `src/metrics/index.ts`
3. Add weight to `src/types/config.ts` and `src/config/defaults.ts`
4. Integrate in `src/scoring/engine.ts`
5. Write tests in `__tests__/metrics/`
