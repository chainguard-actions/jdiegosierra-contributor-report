  ...
  user: {
      ...
      nodes: [
        {
          state: 'MERGED',
          merged: true,
          mergedAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(), // 7 days ago
        ...
        },
        {
          state: 'MERGED',
          merged: true,
          mergedAt: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000).toISOString(),
          createdAt: new Date(Date.now() - 35 * 24 * 60 * 60 * 1000).toISOString(),
          closedAt: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000).toISOString(),
          additions: 200,
          deletions: 75,
          repository: {
        ...
        },
        {
          state: 'MERGED',
          merged: true,
          mergedAt: new Date(Date.now() - 60 * 24 * 60 * 60 * 1000).toISOString(),
        ...
        },
        {
          ...
          closedAt: new Date(Date.now() - 85 * 24 * 60 * 60 * 1000).toISOString(),
          additions: 50,
          deletions: 10,
          repository: {
            owner: { login: 'other' },
      ...
      contributionCalendar: {
        ...
        weeks: Array.from({ length: 52 }, (_, i) => ({
          contributionDays: Array.from({ length: 7 }, (_, j) => ({
            ...
            date: new Date(Date.now() - (i * 7 + j) * 24 * 60 * 60 * 1000).toISOString().split('T')[0]
          }))
        }))
      },
    ...
    issueComments: {
      ...
      nodes: Array.from({ length: 20 }, () => ({
        ...
        reactions: {
          nodes: [{ content: 'THUMBS_UP' as const }, { content: 'HEART' as const }]
        }
      })),
  ...
  user: {
    ...
    pullRequests: {
      ...
      nodes: Array.from({ length: 15 }, (_, i) => ({
        ...
        merged: i < 2,
        mergedAt: i < 2 ? new Date(Date.now() - i * 24 * 60 * 60 * 1000).toISOString() : null,
    ...
    issueComments: {
      ...
      nodes: Array.from({ length: 5 }, () => ({
        ...
        reactions: {
          nodes: [{ content: 'THUMBS_DOWN' as const }, { content: 'CONFUSED' as const }]
        }
      })),
      pageInfo: { hasNextPage: false, endCursor: null }
    }
