...
const { DEFAULT_TRUSTED_USERS, DEFAULT_THRESHOLDS } = await import('../../src/config/defaults.js')
...
describe('Input Parsing', () => {
  ...
  describe('Input Validation', () => {
    it('throws error for invalid prMergeRate threshold (> 1)', () => {
      ...
      expect(() => parseInputs()).toThrow('prMergeRate threshold must be between 0 and 1')
    })
    ...
    it('throws error for negative minimum-stars', () => {
      ...
      expect(() => parseInputs()).toThrow('minimum-stars must be a positive number')
    })
    ...
    it('throws error for analysis-window of zero', () => {
      ...
      expect(() => parseInputs()).toThrow('analysis-window must be greater than 0')
    })
    ...
    it('throws error for invalid required metrics', () => {
      ...
      expect(() => parseInputs()).toThrow('Invalid metric names in required-metrics')
    })
    ...
    it('throws error for negative new-account-threshold-days', () => {
      ...
      expect(() => parseInputs()).toThrow('new-account-threshold-days must be a positive number')
    })
