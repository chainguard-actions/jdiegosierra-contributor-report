 ...
 */
export function extractCodeReviewData(data: GraphQLContributorData): CodeReviewData {
  const reviewCount = data.user.contributionsCollection.pullRequestReviewContributions.totalCount
 ...
 */
export function checkCodeReviews(data: CodeReviewData, threshold: number): MetricCheckResult {
